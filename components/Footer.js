            ...
            <div className="col-xl-5 col-lg-6 col-md-6 col-12 mb-3">
              <div className="row">
                <div className="col-xl-5 col-lg-6 col-md-6 col-sm-6 col-12">
                  ...
                  <div className="footer-bottom-btn-main">
                    <ul>
                      ...
                      <li>
                        <a
                          href="https://convergenceindia.pixieset.com/33rdconvergenceindiaand11thsmartcitiesindia2026expo/"
                          className="d-flex justify-content-between"
                          target="_blank"
                        >
                          <span>2026 Photo Gallery</span> <i className="far fa-arrow-right btn-arrow-icon"></i>
                        </a>
                      </li>
                      <li>
                        <a href="https://www.convergenceindia.org/pg/payment.aspx" className="d-flex justify-content-between">
                          <span>Quick Pay</span> <i className="far fa-arrow-right btn-arrow-icon"></i>
                        </a>
                      </li>
                      <li>
                        <a href="https://www.convergenceindia.org/contact-us.aspx" className="d-flex justify-content-between">
                          <span>Contact Us</span> <i className="far fa-arrow-right btn-arrow-icon"></i>
                        </a>
                      </li>
                    </ul>
                  </div>
                ...
                <div className="col-xl-5 col-lg-6 col-md-6 col-sm-6 col-12 offset-xl-1">
                  <div className="footer-bottom-heading">Let&apos;s Connect</div>
                  <div className="footer-bottom-link">
                    <ul>
                      <li>
                        <strong>Sales &amp; Sponsorship</strong>
                        <br />
                      ...
                      <li>
                        <strong>Visitor &amp; Delegate</strong>
                        <br />
                        <a href="mailto:connect@eigroup.in">connect@eigroup.in</a>
                      </li>
                      <li>
                        <strong>Media &amp; Marketing</strong>
                        <br />
